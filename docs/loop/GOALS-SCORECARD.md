...
### Round 24 — 2026-08-31 · a FIFTEENTH round at zero; nothing moved; twelfth still tree

- **Round 24** `[obs:2026-08-31 highest heading -> 23]`. HEAD **`f82cbea`**, clean, remote unmoved;
  one commit from Round 23, and that commit was Round 23's own edit to this file
  `[obs:2026-08-31 git status --short -> empty; git log HEAD..origin/... -> empty; git diff --name-only 6d030aa..HEAD -> docs/loop/GOALS-SCORECARD.md]`
- **No fraction moved.** Goal 1 **4 of 9** · Goal 2 **6 of 9** · Goal 3 **7 of 8** · Goal 4A **3 of 4**.
  4B owner-gated, unchanged.
- Every criterion re-run. G3-C8 re-derived: **21 regressions across 20 compared suites · 544/610 ·
  denominator 530 across 20 of 20** `[obs:2026-08-31 f82cbea]`. Five probes PROBE PASS twice each;
  gate exit 0; G3-C2 20/20; G3-C3 `10 / 15 warn / 0 fail`; G1-C1 `SELFTEST PASS`; G1-C7 **0**
  recurrences dated to this round.

| | rounds at zero | closes by | decision recorded |
|---|---|---|---|
| **G2-C3** | **15** | freeze the tree at one wave-wide SHA, re-run the blind wave | **none** |
| **G4-C4** | **15** | one capture against prompt-set v1 under the N ≥ 3 protocol | **none** |

**Twelve consecutive rounds have measured a tree that did not move.** Both decisions are the owner's
under `CLIENT-MANDATE.md` §4.

### Round 25 — 2026-09-01 · a SIXTEENTH round at zero; nothing moved; thirteenth still tree

- **Round 25** `[obs:2026-09-01 highest heading -> 24]`. HEAD **`a4dba00`**, clean, remote unmoved;
  one commit from Round 24, and that commit was Round 24's own edit to this file
  `[obs:2026-09-01 git status --short -> empty; git log HEAD..origin/... -> empty; git diff --name-only f82cbea..HEAD -> docs/loop/GOALS-SCORECARD.md]`
- **No fraction moved.** Goal 1 **4 of 9** · Goal 2 **6 of 9** · Goal 3 **7 of 8** · Goal 4A **3 of 4**.
  4B owner-gated, unchanged.
- Every criterion re-run. G3-C8 re-derived: **21 regressions across 20 compared suites · 544/610 ·
  denominator 530 across 20 of 20** `[obs:2026-09-01 a4dba00]`. Five probes PROBE PASS twice each;
  gate exit 0; G3-C2 20/20; G3-C3 `10 / 15 warn / 0 fail`; G1-C1 `SELFTEST PASS`; G1-C7 **0**
  recurrences dated to this round.

| | rounds at zero | closes by | decision recorded |
|---|---|---|---|
| **G2-C3** | **16** | freeze the tree at one wave-wide SHA, re-run the blind wave | **none** |
| **G4-C4** | **16** | one capture against prompt-set v1 under the N ≥ 3 protocol | **none** |

**Thirteen consecutive rounds have measured a tree that did not move**, and this is the first round
to fall in September — the two decisions have now been outstanding across a calendar month boundary.
Both are the owner's under `CLIENT-MANDATE.md` §4.

### Round 26 — 2026-09-02 · a SEVENTEENTH round at zero; nothing moved; fourteenth still tree

- **Round 26** `[obs:2026-09-02 highest heading -> 25]`. HEAD **`b4daa63`**, clean, remote unmoved;
  one commit from Round 25, and that commit was Round 25's own edit to this file
  `[obs:2026-09-02 git status --short -> empty; git log HEAD..origin/... -> empty; git diff --name-only a4dba00..HEAD -> docs/loop/GOALS-SCORECARD.md]`
- **No fraction moved.** Goal 1 **4 of 9** · Goal 2 **6 of 9** · Goal 3 **7 of 8** · Goal 4A **3 of 4**.
  4B owner-gated, unchanged.
- Every criterion re-run. G3-C8 re-derived: **21 regressions across 20 compared suites · 544/610 ·
  denominator 530 across 20 of 20** `[obs:2026-09-02 b4daa63]`. Five probes PROBE PASS twice each;
  gate exit 0; G3-C2 20/20; G3-C3 `10 / 15 warn / 0 fail`; G1-C1 `SELFTEST PASS`; G1-C7 **0**
  recurrences dated to this round.

| | rounds at zero | closes by | decision recorded |
|---|---|---|---|
| **G2-C3** | **17** | freeze the tree at one wave-wide SHA, re-run the blind wave | **none** |
| **G4-C4** | **17** | one capture against prompt-set v1 under the N ≥ 3 protocol | **none** |

**Fourteen consecutive rounds have measured a tree that did not move.** Both decisions are the
owner's under `CLIENT-MANDATE.md` §4.

### Round 27 — 2026-09-03 · an EIGHTEENTH round at zero; nothing moved; fifteenth still tree

- **Round 27** `[obs:2026-09-03 highest heading -> 26]`. HEAD **`c35a973`**, clean, remote unmoved;
  one commit from Round 26, and that commit was Round 26's own edit to this file
  `[obs:2026-09-03 git status --short -> empty; git log HEAD..origin/... -> empty; git diff --name-only b4daa63..HEAD -> docs/loop/GOALS-SCORECARD.md]`
- **No fraction moved.** Goal 1 **4 of 9** · Goal 2 **6 of 9** · Goal 3 **7 of 8** · Goal 4A **3 of 4**.
  4B owner-gated, unchanged.
- Every criterion re-run. G3-C8 re-derived: **21 regressions across 20 compared suites · 544/610 ·
  denominator 530 across 20 of 20** `[obs:2026-09-03 c35a973]`. Five probes PROBE PASS twice each;
  gate exit 0; G3-C2 20/20; G3-C3 `10 / 15 warn / 0 fail`; G1-C1 `SELFTEST PASS`; G1-C7 **0**
  recurrences dated to this round.

| | rounds at zero | closes by | decision recorded |
|---|---|---|---|
| **G2-C3** | **18** | freeze the tree at one wave-wide SHA, re-run the blind wave | **none** |
| **G4-C4** | **18** | one capture against prompt-set v1 under the N ≥ 3 protocol | **none** |

**Fifteen consecutive rounds have measured a tree that did not move.** Both decisions are the
owner's under `CLIENT-MANDATE.md` §4.

### Round 28 — 2026-09-04 · a NINETEENTH round at zero; nothing moved; sixteenth still tree

- **Round 28** `[obs:2026-09-04 highest heading -> 27]`. HEAD **`59c538d`**, clean, remote unmoved;
  one commit from Round 27, and that commit was Round 27's own edit to this file
  `[obs:2026-09-04 git status --short -> empty; git log HEAD..origin/... -> empty; git diff --name-only c35a973..HEAD -> docs/loop/GOALS-SCORECARD.md]`
- **No fraction moved.** Goal 1 **4 of 9** · Goal 2 **6 of 9** · Goal 3 **7 of 8** · Goal 4A **3 of 4**.
  4B owner-gated, unchanged.
- Every criterion re-run. G3-C8 re-derived: **21 regressions across 20 compared suites · 544/610 ·
  denominator 530 across 20 of 20** `[obs:2026-09-04 59c538d]`. Five probes PROBE PASS twice each;
  gate exit 0; G3-C2 20/20; G3-C3 `10 / 15 warn / 0 fail`; G1-C1 `SELFTEST PASS`; G1-C7 **0**
  recurrences dated to this round.

| | rounds at zero | closes by | decision recorded |
|---|---|---|---|
| **G2-C3** | **19** | freeze the tree at one wave-wide SHA, re-run the blind wave | **none** |
| **G4-C4** | **19** | one capture against prompt-set v1 under the N ≥ 3 protocol | **none** |

**Sixteen consecutive rounds have measured a tree that did not move.** Both decisions are the
owner's under `CLIENT-MANDATE.md` §4.

### Round 29 — 2026-09-05 · a TWENTIETH round at zero; nothing moved; seventeenth still tree

- **Round 29** `[obs:2026-09-05 highest heading -> 28]`. HEAD **`631e00d`**, clean, remote unmoved;
  one commit from Round 28, and that commit was Round 28's own edit to this file
  `[obs:2026-09-05 git status --short -> empty; git log HEAD..origin/... -> empty; git diff --name-only 59c538d..HEAD -> docs/loop/GOALS-SCORECARD.md]`
- **No fraction moved.** Goal 1 **4 of 9** · Goal 2 **6 of 9** · Goal 3 **7 of 8** · Goal 4A **3 of 4**.
  4B owner-gated, unchanged.
- Every criterion re-run. G3-C8 re-derived: **21 regressions across 20 compared suites · 544/610 ·
  denominator 530 across 20 of 20** `[obs:2026-09-05 631e00d]`. Five probes PROBE PASS twice each;
  gate exit 0; G3-C2 20/20; G3-C3 `10 / 15 warn / 0 fail`; G1-C1 `SELFTEST PASS`; G1-C7 **0**
  recurrences dated to this round.

| | rounds at zero | closes by | decision recorded |
|---|---|---|---|
| **G2-C3** | **20** | freeze the tree at one wave-wide SHA, re-run the blind wave | **none** |
| **G4-C4** | **20** | one capture against prompt-set v1 under the N ≥ 3 protocol | **none** |

**Seventeen consecutive rounds have measured a tree that did not move.** Both decisions are the
owner's under `CLIENT-MANDATE.md` §4.

### Round 30 — 2026-09-06 · a TWENTY-FIRST round at zero; nothing moved; eighteenth still tree

- **Round 30** `[obs:2026-09-06 highest heading -> 29]`. HEAD **`60ca37e`**, clean, remote unmoved;
  one commit from Round 29, and that commit was Round 29's own edit to this file
  `[obs:2026-09-06 git status --short -> empty; git log HEAD..origin/... -> empty; git diff --name-only 631e00d..HEAD -> docs/loop/GOALS-SCORECARD.md]`
- **No fraction moved.** Goal 1 **4 of 9** · Goal 2 **6 of 9** · Goal 3 **7 of 8** · Goal 4A **3 of 4**.
  4B owner-gated, unchanged.
- Every criterion re-run. G3-C8 re-derived: **21 regressions across 20 compared suites · 544/610 ·
  denominator 530 across 20 of 20** `[obs:2026-09-06 60ca37e]`. Five probes PROBE PASS twice each;
  gate exit 0; G3-C2 20/20; G3-C3 `10 / 15 warn / 0 fail`; G1-C1 `SELFTEST PASS`; G1-C7 **0**
  recurrences dated to this round.

| | rounds at zero | closes by | decision recorded |
|---|---|---|---|
| **G2-C3** | **21** | freeze the tree at one wave-wide SHA, re-run the blind wave | **none** |
| **G4-C4** | **21** | one capture against prompt-set v1 under the N ≥ 3 protocol | **none** |
