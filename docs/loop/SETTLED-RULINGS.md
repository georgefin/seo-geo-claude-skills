...
- **Encoded in repo**: `build/schema-markup-generator/SKILL.md:223`; `VERSIONS.md:249`
...
- **Encoded in repo**: `monitor/performance-reporter/references/kpi-definitions.md:300-306`
  ...
  `VERSIONS.md:250` ("technical-seo-checker 4.0.1", anchor-tagged per F12 — token
...
| Google AI Mode in Greek | live since 2025-10-08 (`VERSIONS.md:245` ("non-levers")) | 2026-08-09 |
