...
- **Encoded in repo**: `build/schema-markup-generator/SKILL.md:223`; `VERSIONS.md:305`
...
- **Encoded in repo**: `monitor/performance-reporter/references/kpi-definitions.md:453-455`
  ...
  `VERSIONS.md:306` ("technical-seo-checker 4.0.1", anchor-tagged per F12 — token
...
| Google AI Mode in Greek | live since 2025-10-08 (`VERSIONS.md:301` ("non-levers")) | 2026-08-09 |
