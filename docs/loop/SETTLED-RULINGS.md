...
- **Encoded in repo**: `build/geo-content-optimizer/SKILL.md:159`;
  `build/geo-content-optimizer/references/ai-citation-patterns.md:478`; `VERSIONS.md:149` ("non-levers")
...
- **Encoded in repo**: `build/geo-content-optimizer/SKILL.md:159`;
  `build/geo-content-optimizer/references/ai-citation-patterns.md:478`; `VERSIONS.md:149` ("non-levers")
  (pointers refreshed 2026-08-09, same shift as R1; VERSIONS pointer re-refreshed 2026-08-10);
...
- **Encoded in repo**: `build/schema-markup-generator/SKILL.md:223`; `VERSIONS.md:153`
  ("schema-markup-generator 4.0.1" — anchor-tagged per F12; on any line/token
  mismatch, grep the token — the token is authoritative).
...
- **Encoded in repo**: `monitor/performance-reporter/references/kpi-definitions.md:298-304`
  ...
  `VERSIONS.md:154` ("technical-seo-checker 4.0.1", anchor-tagged per F12 — token
...
| Google AI Mode in Greek | live since 2025-10-08 (`VERSIONS.md:149` ("non-levers")) | 2026-08-09 |
