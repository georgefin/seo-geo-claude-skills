...
- **Encoded in repo**: `build/geo-content-optimizer/SKILL.md:159`;
  `build/geo-content-optimizer/references/ai-citation-patterns.md:478`; `VERSIONS.md:87`
...
- **Encoded in repo**: `build/schema-markup-generator/SKILL.md:223`; `VERSIONS.md:91`
  (pointer refreshed 2026-08-09 — stale since the v4.3.0 insertion, shifted again by v4.3.1).
...
- **Encoded in repo**: `monitor/performance-reporter/references/kpi-definitions.md:298-304`
  ...
  `VERSIONS.md:92` (refreshed 2026-08-09); `optimize/technical-seo-checker/SKILL.md:258` (pointer refreshed
...
| Google AI Mode in Greek | live since 2025-10-08 (`VERSIONS.md:87`) | 2026-08-09 |
