...
**32 rows — 6 in A, 16 in B, 1 in C, 9 in D**, 32 distinct ids (60–91 contiguous), no duplicates;
#80 is resolved.
[obs: `grep -cE '^\| [0-9]+ \|'` = 32 · `grep -oE '^\| [0-9]+ \|' | grep -oE '[0-9]+' | sort -un | wc -l` = 32 · section D = 9, 2026-08-12]
